   ...
   <section class="bg-[#F7F2EE] pt-[112px] md:pt-[240px] pb-[40px]">
    <div class="max-w-[1296px] mx-auto md:flex items-start px-[12px]">
     <div class="w-full max-w-[746px] md:pr-[16px] lg:pr-[72px]">
      ...
      <h6
       class="text-[1.25rem] md:text-[1.75rem] font-bold mb-[32px] md:mb-[40px]"
      >
       訂房資訊
      </h6>
      <div class="flex items-center justify-between">
       <div>
        <DecoTitle customClass="mb-[8px] before:bg-[#BF9D7D]"
         >選擇房型</DecoTitle
        >
        <p class="mb-[24px]">尊爵雙人房</p>
       </div>
       <router-link class="underline underline-offset-1 font-bold"
        >編輯</router-link
       >
      </div>
      <div class="flex items-center justify-between">
      ...
      <form action="">
       <div class="mb-[24px]">
        <label
         class="text-[0.875rem] md:text-[1rem] font-bold mb-[8px] block"
         for=""
         >姓名</label
        >
       ...
       ></DivideLine>
       <h5
        class="text-[1.25rem] md:text-[2rem] font-bold mb-[32px] md:mb-[40px]"
       >
        房間資訊
       </h5>
       <div class="mb-[24px]">
        <DecoTitle customClass="mb-[24px] md:text-[1.5rem] before:bg-[#BF9D7D]"
         >房型基本資訊</DecoTitle
        >
     ...
     <aside
      class="p-[40px] bg-[#FFFFFF] rounded-xl w-full md:max-w-[478px] sticky top-[120px]"
     >
      <div class="max-w-full md:max-w-[398px] mb-[40px]">
       <img class="rounded-lg" :src="`${room2_1}`" alt="" />
      </div>
      <h6 class="text-[1.25rem] md:text-[1.75rem] font-bold mb-[24px]">
       價格詳情
      </h6>
