<template>
 <div class="min-h-[100%]">
  <Header></Header>
  <main>
   <section class="bg-[#F7F2EE] pt-[240px] pb-[120px]">
    <div class="max-w-[1296px] mx-auto flex items-start">
     <div class="w-full max-w-[746px] mr-[72px]">
      <div class="flex items-center mb-[40px]">
       <button>
        <svg class="w-[40px] h-[40px]" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <h6 class="md:text-[1.75rem] font-bold mb-[40px]">訂房資訊</h6>
      ...
      <DivideLine customClass="bg-[#909090] my-[47px]"></DivideLine>
      <div class="flex items-center justify-between mb-[40px]">
       <h5 class="md:text-[2rem] font-bold">訂房人資訊</h5>
      ...
      <form action="">
       ...
       <DivideLine customClass="bg-[#909090] my-[47px]"></DivideLine>       
       <h5 class="md:text-[2rem] font-bold mb-[40px]">房間資訊</h5>
       <div class="mb-[24px]">
        <DecoTitle customClass="mb-[24px] md:text-[24px] ">房型基本資訊</DecoTitle>
        <BasicInfo roomSize="24" bedCount="1" peopleCount="2-4"></BasicInfo>
       </div>
       <div class="mb-[24px]">
        <DecoTitle customClass="mb-[24px] md:text-[24px] ">房間格局</DecoTitle>
       ...
       <div class="mb-[24px]">
        <DecoTitle customClass="mb-[24px] md:text-[24px] ">房內設備</DecoTitle>
        <div class="w-full grid grid-cols-5 gap-[8px] auto-cols-auto px-[24px] py-[24px] items-center bg-[#FFFFFF] rounded-lg">
         <CheckItem>平面電視</CheckItem>
         <CheckItem>吹風機</CheckItem>
         <CheckItem>冰箱</CheckItem>
         <CheckItem>熱水壺</CheckItem>
         <CheckItem>檯燈</CheckItem>
         <CheckItem>衣櫃</CheckItem>
         <CheckItem>除濕機</CheckItem>
         <CheckItem>浴缸</CheckItem>
         <CheckItem>書桌</CheckItem>
         <CheckItem>音響</CheckItem>        
        </div>
       </div>
       <div class="mb-[24px]">
        <DecoTitle customClass="mb-[24px] md:text-[24px] ">備品提供</DecoTitle>
        <div class="w-full grid grid-cols-5 gap-[8px] auto-cols-auto px-[24px] py-[24px] items-center bg-[#FFFFFF] rounded-lg">
         <CheckItem>衛生紙</CheckItem>
         <CheckItem>拖鞋</CheckItem>
         <CheckItem>沐浴用品</CheckItem>
         <CheckItem>清潔用品</CheckItem>
         <CheckItem>刮鬍刀</CheckItem>
         <CheckItem>吊衣架</CheckItem>
         <CheckItem>浴巾</CheckItem>
         <CheckItem>刷牙用品</CheckItem>
         <CheckItem>罐裝水</CheckItem>
         <CheckItem>梳子</CheckItem>         
        </div>
       </div>
      </form>
     </div>     
     <aside class="p-[40px] bg-[#FFFFFF] rounded-xl w-full max-w-[478px] sticky top-[120px]">
      <div class="max-w-[398px] mb-[40px]">
       <img class="rounded-lg" :src="`${room2_1}`" alt="">
      </div>     
      <h6 class="md:text-[1.75rem] font-bold mb-[24px]">價格詳情</h6>
