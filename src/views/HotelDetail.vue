 ...
 <div class="min-h-[100%]">
  ...
  <main>
    <section class="relative bg-[#F7F2EE] px-0 lg:px-[12px] pt-[72px] lg:pt-[200px] lg:pb-[80px]">
     ...
     <router-link :to="{name:'AllHotel'}" class="absolute bottom-[23px] right-[12px] lg:hidden w-[113px] h-[56px] border-[#BF9D7D] bg-[#FFFFFF] rounded-lg font-bold text-[#BF9D7D] flex items-center justify-center">看更多</router-link>     
    </section>
    <section class="relative bg-[#F7F2EE] px-[12px] py-[40px] lg:pt-[120px] lg:pb-[120px]">
     <div class="max-w-[1296px] mx-auto md:flex items-start">
      <div class="w-full max-w-full lg:max-w-[746px] lg:mr-[72px]">
       ...
       <p class="text-[0.875rem] mb-[24px] md:mb-[80px]">享受高級的住宿體驗，尊爵雙人房提供給您舒適寬敞的空間和精緻的裝潢。</p>       
       <div class="mb-[24px] md:mb-[80px]">
        <DecoTitle customClass="mb-[16px] md:mb-[24px] text-[1rem] md:text-[1.5rem] before:bg-[#BF9D7D]">房型基本資訊</DecoTitle>
        <BasicInfo roomSize="24" bedCount="1" peopleCount="2-4"></BasicInfo>
       </div>
       <div class="mb-[24px] md:mb-[80px]">
        <DecoTitle customClass="mb-[16px] md:mb-[24px] text-[1rem] md:text-[1.5rem] before:bg-[#BF9D7D]">房間格局</DecoTitle>
       ...
       <div class="mb-[24px] md:mb-[80px]">
        <DecoTitle customClass="mb-[16px] md:mb-[24px] text-[1rem] md:text-[1.5rem] before:bg-[#BF9D7D]">房內設備</DecoTitle>
       ...
       <div class="mb-[24px] md:mb-[80px]">
        <DecoTitle customClass="mb-[16px] md:mb-[24px] text-[1rem] md:text-[1.5rem] before:bg-[#BF9D7D]">備品提供</DecoTitle>
        <div class="w-full grid grid-cols-2 xl:grid-cols-5 gap-[8px] auto-cols-auto px-[24px] py-[24px] items-center bg-[#FFFFFF] rounded-lg">
       ...
       <div class="md:mb-[80px]">
        <DecoTitle customClass="mb-[16px] md:mb-[24px] text-[1rem] md:text-[1.5rem] before:bg-[#BF9D7D]">訂房須知</DecoTitle>
  ...
  <div v-if="!calendarStore.isShow" class="fixed lg:hidden bottom-0 w-full p-[12px] bg-[#FFFFFF] flex justify-between items-center border-[#ECECEC] border-[1px]">
    <p class="text-[0.875rem] text-[#4B4B4B]">ＮＴ$ 10,000 / 晚</p>
    <div class="w-full max-w-[194px]">
      <ClickButton @click="checkOrder" isLink="false" customClass="bg-[#BF9D7D] text-[#FFFFFF]">
        查看可訂日期
      </ClickButton>
    </div>    
  </div>  
