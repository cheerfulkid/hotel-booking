  ...
  <main>
   <section class="bg-[#140F0A] pt-[112px] md:pt-[240px]">
    <div class="max-w-[1296px] mx-auto md:flex items-start px-[12px]">
     <div
      class="w-full max-w-[746px] md:pr-[16px] lg:pr-[72px] mb-[60px] md:mb-0"
     >
      <div class="md:flex mb-[32px] md:mb-[40px] md:flex-wrap">
       ...
       <h3
        class="text-[2rem] md:text-[2rem] lg:text-[3rem] font-bold text-[#FFFFFF]"
       >
        恭喜，Grace！<br />您已預訂成功
       </h3>
      </div>
      ...
      <DivideLine
       customClass="bg-[#ECECEC] my-[40px] md:my-[80px]"
      ></DivideLine>
      <h6
       class="text-[1rem] md:text-[1.5rem] font-bold mb-[24px] md:mb-[40px] text-[#FFFFFF]"
      >
       立即查看您的訂單紀錄
      </h6>
      <div class="max-w-full lg:max-w-[218px]">
       <ClickButton
        customClass="bg-[#BF9D7D] text-[#FFFFFF]"
        :to="{ name: 'Order' }"
       >
        前往我的訂單
       </ClickButton>
      ...
      <DivideLine
       customClass="bg-[#ECECEC] my-[40px] md:my-[80px]"
      ></DivideLine>
      <h6 class="text-[1.5rem] font-bold mb-[32px] md:mb-[40px] text-[#FFFFFF]">
       訂房人資訊
      </h6>
      ...
      <p class="text-[#FFFFFF] font-bold mb-[24px] text-[#FFFFFF]">
       +886 912 345 678
      </p>
     ...
     <aside
      class="p-[16px] md:p-[40px] bg-[#FFFFFF] rounded-xl w-full md:max-w-[478px] sticky top-[120px]"
     >
      <p class="mb-[8px] text-[0.875rem] md:text-[1rem] text-[#4B4B4B]">
       預訂參考編號： HH2302183151222
      </p>
      <p class="text-[1rem] md:text-[1.5rem] font-bold mb-[24px] md:mb-[40px]">
       即將來的行程
      </p>
      <img
      ...
      />
      <p
       class="text-[#4B4B4B] text-[0.875rem] md:text-[1.25rem] flex items-center mb-[24px] font-bold"
      >
       尊爵雙人房，1 晚<span
        class="bg-[#909090] w-[1px] h-full inline-block mx-[16px]"
       ></span
       >住宿人數：2 位
      </p>
      <DecoTitle
       customClass="mb-[8px] before:bg-[#BF9D7D] text-[0.875rem] md:text-[1rem]"
       >入住：6 月 10 日星期二，15:00 可入住</DecoTitle
      >
      <DecoTitle
       customClass="before:bg-[#909090] mb-[24px] text-[0.875rem] md:text-[1rem]"
       >退房：6 月 11 日星期三，12:00 前退房</DecoTitle
      >
      <p class="font-bold text-[#4B4B4B] text-[0.875rem] md:text-[1rem]">
       NT$ 10,000
      </p>
      <DivideLine
       customClass="bg-[#ECECEC] my-[24px] md:my-[40px]"
      ></DivideLine>
      <DecoTitle
       customClass="mb-[24px] before:bg-[#BF9D7D] text-[0.875rem] md:text-[1rem]"
       >房內設備</DecoTitle
      >
      <div
      ...
      >
       ...
       <CheckItem customClass="text-[0.875rem] md:text-[1rem]"
        >吹風機</CheckItem
       >
       <CheckItem customClass="text-[0.875rem] md:text-[1rem]"
        >熱水壺</CheckItem
