<template>
 <div class="md:flex md:items-start">
  <div class="w-full max-w-full md:max-w-[730px] md:mr-[40px] bg-[#FFFFFF] rounded-lg p-[16px] lg:p-[40px] mb-[24px] md:mb-0">
   ...
   <img class="w-full max-w-full md:max-w-full h-[240px] object-cover object-left-bottom mb-[24px] md:mb-[40px] rounded-lg" :src="`${room2_1}`" alt="">
   ...
   <div class="w-full grid grid-cols-2 xl:grid-cols-5 gap-[8px] auto-cols-auto px-[24px] py-[24px] items-center border-[1px] rounded-lg mb-[24px] md:mb-[40px]">
  ...
  <div class="w-full max-w-full md:max-w-[527px] bg-[#FFFFFF] mb-[24px] md:mb-0 rounded-lg p-[16px] lg:p-[40px]">
   ...
   <div class="lg:flex">
    ...
    <div>
     ...
     <DecoTitle customClass="mb-[8px] before:bg-[#BF9D7D] text-[#4B4B4B] text-[0.875rem] md:text-[1rem]">入住：6 月 10 日星期二，15:00 可入住</DecoTitle>
     <DecoTitle customClass="before:bg-[#909090] mb-[24px] text-[#4B4B4B] text-[0.875rem] md:text-[1rem]">退房：6 月 11 日星期三，12:00 前退房</DecoTitle>
   ...
   <ClickButton customClass="mt-[40px] border-[1px] border-[#BF9D7D] text-[#BF9D7D] flex items-center justify-center" :to="{ name: 'AllHotel' }">
    ...
    <svg class="mr-[4px] w-[24px] h-[24px]" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
     <g clip-path="url(#clip0_14_2286)">
      <path class="fill-[#BF9D7D]" d="M7.41 8.59009L12 13.1701L16.59 8.59009L18 10.0001L12 16.0001L6 10.0001L7.41 8.59009Z" fill="black"/>
     </g>
     <defs>
 ...
 <Modal>
  ...
  <template #content>
    <p class="text-[#4B4B4B] h-[224px] flex items-center text-[0.875rem] md:text-[1.25rem] font-bold">確定要取消此房型的預訂嗎？</p>  
