 ...
 <main>
  <div class="flex h-full pt-[120px]">
   ...
   <template v-if="route.params.step!='2'">
    <div :class="`w-full before:top-[32px] before:bg-no-repeat before:bg-contain md:w-[50%] relative before:absolute before:w-full before:h-[170px] before:bg-[url(${smLine3})] md:before:bg-[url(${line3})] md:before:bg-cover before:block before:left-0 md:before:top-[72px] bg-no-repeat md:px-[20px]`">
     <div class="max-w-full md:max-w-[416px] mx-[20px] md:mx-auto pt-[92px] md:pt-[159px]">
      <span class="text-[1rem] text-[#BF9D7D] line-height-[24px] font-bold relative">享樂酒店，誠摯歡迎</span>
      <h3 class="pt-[8px] pb-[32px] text-[#FFFFFF] text-[3rem] font-bold line-height-[57.6px] relative">立即註冊</h3>
      ...
      <form class="mt-[56px]">
       <div class="flex flex-col mb-[8px]">
        <label for="" class="text-[#FFFFFF] text-[1rem] line-height-[24px] font-bold mb-[8px]">電子信箱</label>
        <input type="email" v-model="signupData.email" class="placeholder:text-[1rem] placeholder:text-[#909090] p-[16px] rounded-[8px]" placeholder="hello@exsample.com">
       </div>
       <div class="flex flex-col mb-[16px]"> 
        <label for="" class="text-[#FFFFFF] text-[1rem] line-height-[24px] font-bold mb-[8px]">密碼</label>
        <input type="password" v-model="signupData.password" class="placeholder:text-[1rem] placeholder:text-[#909090] p-[16px] rounded-[8px]" placeholder="請輸入密碼">
       </div>
       <div class="flex flex-col mb-[40px]"> 
        <label for="" class="text-[#FFFFFF] text-[1rem] line-height-[24px] font-bold mb-[8px]">確認密碼</label>
        <input type="password" v-model="checkPassword" class="placeholder:text-[1rem] placeholder:text-[#909090] p-[16px] rounded-[8px]" placeholder="請再輸入一次密碼">
       </div>
   ...
   <template v-else>
    <div :class="`w-full before:top-[32px] before:bg-no-repeat before:bg-contain md:w-[50%] relative before:absolute before:w-full before:h-[170px] before:bg-[url(${smLine3})] md:before:bg-[url(${line3})] md:before:bg-cover before:block before:left-0 md:before:top-[72px] bg-no-repeat md:px-[20px]`">
     <div class="max-w-full md:max-w-[416px] mx-[20px] md:mx-auto pt-[92px] md:pt-[159px]">      
      <h3 class="pt-[8px] pb-[16px] text-[#FFFFFF] text-[3rem] font-bold line-height-[57.6px] relative">立即註冊</h3>
      ...
      <form class="mt-[56px]">
       <div class="flex flex-col mb-[8px]">
        <label for="" class="text-[#FFFFFF] text-[1rem] line-height-[24px] font-bold mb-[8px]">姓名</label>
        <input type="text" v-model="signupData.name" class="placeholder:text-[1rem] placeholder:text-[#909090] p-[16px] rounded-[8px]" placeholder="請輸入姓名">
       </div>
       <div class="flex flex-col mb-[16px]"> 
        <label for="" class="text-[#FFFFFF] text-[1rem] line-height-[24px] font-bold mb-[8px]">手機號碼</label>
        <input type="text" v-model="signupData.phone" class="placeholder:text-[1rem] placeholder:text-[#909090] p-[16px] rounded-[8px]" placeholder="請輸入手機號碼">
       </div>
       <div class="flex flex-col mb-[16px]"> 
        <label for="" class="text-[#FFFFFF] text-[1rem] line-height-[24px] font-bold mb-[8px]">生日</label>
        <div class="flex">
       ...
       <div class="flex flex-col mb-[16px]"> 
        <label for="" class="text-[#FFFFFF] text-[1rem] line-height-[24px] font-bold mb-[8px]">地址</label>
        <div class="flex">
        ...
        <div class="flex mt-[16px]">
         <div class="w-full">         
          <input class="w-full placeholder:text-[1rem] placeholder:text-[#909090] p-[16px] rounded-[8px]" v-model="signupData.address.detail" name="" id="">
         </div>
        </div> 
       </div>
