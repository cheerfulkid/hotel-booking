    ...
    <template v-if="route.params.step!='2'">
      <div class="z-10 w-full md:w-[50%] relative bg-no-repeat md:px-[20px] pt-[32px] md:pt-[159px]">
        ...
        <div class="z-10 max-w-full md:max-w-[416px] mx-[20px] md:mx-auto">
          ...
          <h3 class="pt-[8px] pb-[16px] md:pb-[40px] text-[#FFFFFF] text-[2rem] md:text-[3rem] font-bold line-height-[57.6px] relative">立即註冊</h3>
          ...
          <div class="flex flex-col mb-[16px]">
            <label for="" class="text-[0.875rem] md:text-[1rem] text-[#FFFFFF] text-[1rem] line-height-[24px] font-bold mb-[8px]">電子信箱</label>
            <input type="email" v-model="signupData.email" class="placeholder:text-[0.875rem] md:placeholder:text-[1rem] placeholder:text-[#909090] p-[16px] rounded-[8px]" placeholder="hello@exsample.com">
          </div>
          <div class="flex flex-col mb-[16px]"> 
            <label for="" class="text-[0.875rem] md:text-[1rem] text-[#FFFFFF] text-[1rem] line-height-[24px] font-bold mb-[8px]">密碼</label>
            <input type="password" v-model="signupData.password" class="placeholder:text-[0.875rem] md:placeholder:text-[1rem] placeholder:text-[#909090] p-[16px] rounded-[8px]" placeholder="請輸入密碼">
          </div>
          <div class="flex flex-col mb-[40px]"> 
            <label for="" class="text-[0.875rem] md:text-[1rem] text-[#FFFFFF] text-[1rem] line-height-[24px] font-bold mb-[8px]">確認密碼</label>
            <input type="password" v-model="checkPassword" class="placeholder:text-[0.875rem] md:placeholder:text-[1rem] placeholder:text-[#909090] p-[16px] rounded-[8px]" placeholder="請再輸入一次密碼">
          </div>
          ...
          <p class="text-[0.875rem] md:text-[1rem] text-[#FFFFFF] mb-[94px]">已經有會員了嗎？<router-link :to="{name: 'Login'}" class="mt-[8px] text-[#BF9D7D] underline font-bold">立即登入</router-link></p> 
        </div>    
      </div>
    </template> 
    <template v-else>
      <div class="z-10 w-full md:w-[50%] relative md:px-[20px] pt-[32px] md:pt-[159px]">
        ...
        <div class="z-10 max-w-full md:max-w-[416px] mx-[20px] md:mx-auto">   
          ...
          <div class="flex flex-col mb-[16px]">
            ...
            <input type="text" v-model="signupData.name" class="placeholder:text-[0.875rem] md:placeholder:text-[1rem] placeholder:text-[#909090] p-[16px] rounded-[8px]" placeholder="請輸入姓名">
          </div>
          <div class="flex flex-col mb-[16px]"> 
            <label for="" class="text-[#FFFFFF] text-[0.875rem] md:text-[1rem] line-height-[24px] font-bold mb-[8px]">手機號碼</label>
            <input type="text" v-model="signupData.phone" class="placeholder:text-[0.875rem] md:placeholder:text-[1rem] placeholder:text-[#909090] p-[16px] rounded-[8px]" placeholder="請輸入手機號碼">
          </div>
          <div class="flex flex-col mb-[16px]"> 
          ...
          <div class="flex flex-col mb-[16px]"> 
            ...
            <div class="w-full">         
              <input class="w-full placeholder:text-[0.875rem] md:placeholder:text-[1rem] placeholder:text-[#909090] p-[16px] rounded-[8px]" v-model="signupData.address.detail" name="" id="">
            </div>
            </div> 
          </div>
          <div class="flex items-center mb-[40px]">
            ...
            <label for="agree" class="text-[#FFFFFF] text-[0.875rem] md:text-[1rem] line-height-[24px] font-bold">我已閱讀並同意本網站個資使用規範</label>
          </div>
