     ...
     <div class="lg:max-w-[416px] mx-auto lg:pt-[159px]">
      ...
      <form class="mt-[56px]">
       ...
       <div class="flex flex-col mb-[40px]"> 
        ...
        <input type="text" class="placeholder:text-[16px] placeholder:text-[#909090] p-[16px] rounded-[8px]" placeholder="請再輸入一次密碼">
       </div>
     ...
     <div class="lg:max-w-[416px] mx-auto lg:pt-[159px]">      
      ...
      <form class="mt-[56px]">
       ...
       <div class="flex flex-col mb-[16px]"> 
        ...
        <input type="text" class="placeholder:text-[16px] placeholder:text-[#909090] p-[16px] rounded-[8px]" placeholder="請輸入手機號碼">
       </div>
       <div class="flex flex-col mb-[16px]"> 
        <label for="" class="text-[#FFFFFF] text-[16px] line-height-[24px] font-bold mb-[8px]">生日</label>
        <div class="flex">
         <div class="w-1/3 pr-[8px]">         
          <select class="w-full" name="" id=""></select>
         </div> 
         <div class="w-1/3 pr-[8px]">         
          <select class="w-full" name="" id=""></select>
         </div> 
