 ...
 <div class="min-h-[100%]">
  ...
  <main class="overflow-hidden">
    <section class="relative">
      ...
      <div class="w-full pl-[26px] pr-[46px] absolute top-0 z-20 h-full">
        <div class="flex flex-col md:flex-row mx-auto w-full relative max-w-[335px] md:max-w-[1760px] h-full mt-[112px] md:mt-0 md:justify-center md:items-center md:justify-between">
          <div class="w-full md:max-w-[636px] md:mr-[80px]">
          ...
          <div class="w-full md:max-w-[772px] relative top-[40px] lg:top-0 before:absolute before:w-full before:max-w-[291px] md:before:max-w-[924px] before:h-[420px] md:before:h-[350px] 2xl:before:h-[678px] left-[-20px] md:left-[-48px] before:left-[48px] before:top-[-60px] md:before:top-[-50px] 2xl:before:top-[-96px] before:rounded-[40px] md:before:rounded-[60px] before:bg-white/10 before:backdrop-blur-sm before:border-t-2 before:border-r-2 before:border-white">
            <h2 class="ml-[10px] md:ml-0 mb-[24px] relative z-10 text-[3rem] 2xl:text-[6.25rem] text-[#FFFFFF] font-bold">高雄<br>豪華住宿之選</h2>
            <p class="ml-[10px] mr-[24px] md:mr-0 md:ml-0 relative z-10 text-[1rem] 2xl:text-[2rem] text-[#FFFFFF] mb-[40px] 2xl:mb-[60px] font-bold">我們致力於為您提供無與倫比的奢華體驗與優質服務</p>
            <router-link :to="{name:'Book'}" class="ml-[10px] relative z-10 h-[64px] 2xl:h-[116px] flex items-center px-[40px] 2xl:text-[1.5rem] bg-[#FFFFFF] block w-full rounded-lg hover:bg-[#BF9D7D] hover:text-[#FFFFFF] group"><span class="flex justify-end items-center w-full font-bold">立即訂房<span class="ml-[15px] h-[2px] bg-[#140F0A] block w-full max-w-[80px]  md:max-w-[150px] group-hover:bg-[#FFFFFF]"></span></span></router-link>
          </div>
        </div>
      </div>      
    </section>
    <section class="px-[12px] pt-[80px] pb-[80px] md:pt-[256px] md:pb-[120px] bg-[#F7F2EE]">
      <div :class="`w-full md:max-w-[1296px] mx-auto flex flex-col xl:flex-row items-start justify-between  relative before:z-[40] before:absolute before:z-10 before:left-0 before:bottom-[-140px] md:before:left-[-112px] md:before:bottom-[-200px] before:w-[100px] before:h-[100px] 2xl:before:w-[200px] 2xl:before:h-[200px] before:bg-contain before:bg-[url(${dot})] after:absolute after:right-0 after:top-[-40px] md:after:right-[-68px] md:after:top-[-10px] after:w-[100px] after:h-[100px] 2xl:after:w-[200px] 2xl:after:h-[200px] after:bg-contain after:bg-[url(${dot})]`">
        <h3 class="text-[#BF9D7D] text-[2rem] md:text-[3rem] relative mb-[40px] xl:mb-0 before:absolute pb-[24px] md:pb-[40px] before:bottom-0 before:h-[2px] before:w-[140px] before:bg-gradient-to-r before:from-[#BE9C7C] before:to-[#FFFFFF] font-bold">最新<br>消息</h3>
        <div>
          <div class="flex flex-col md:flex-row items-center mb-[40px]">
            ...
            <div class="w-full md:max-w-[602px] md:pl-[24px]">
              ...
              <p class="text-[0.875rem] md:text-[1rem]">秋天就是要來場豪華的旅遊！我們為您準備了一系列的秋季特別方案，包括舒適的住宿、美食饗宴，以及精彩的活動。不論您是想來一趟浪漫之旅，還是想和家人共度美好時光，都能在這裡找到最適合的方案。</p>
            </div>
          </div>
          <div class="flex flex-col md:flex-row items-center mb-[40px]">
            ...
            <div class="w-full md:max-w-[602px] md:pl-[24px]">
              ...
              <p class="text-[0.875rem] md:text-[1rem]">我們知道，有時候您只是需要一個舒適的地方放鬆心情。因此，我們推出了「輕鬆住房專案」，讓您無壓力地享受住宿。不管是短期的休息，還是長期的住宿，我們都會以最貼心的服務，讓您感到賓至如歸。</p>
            </div>
          </div>
          <div class="flex flex-col md:flex-row items-center">
            ...
            <div class="w-full md:max-w-[602px] md:pl-[24px]">
              ...
              <p class="text-[0.875rem] md:text-[1rem]">聖誕節來臨，我們為您準備了特別的禮物！在聖誕期間訂房，不僅有特別優惠，還會送上我們精心準備的聖誕禮物。讓我們一起慶祝這個溫馨的節日吧！</p>
            </div>
          </div>
        </div>
      </div>
    </section>
    <section :class="`bg-[#140F0A] pt-[80px] md:pt-[120px] relative z-30 before:absolute before:bg-[url(${about})] before:w-full before:h-[594px] md:before:h-[672px] before:bg-center before:bg-cover`">
      <div class="max-w-[1044px] p-[24px] md:p-[80px] rounded-tl-[40px] rounded-bl-[40px] rounded-tr-[40px] md:rounded-tl-[60px] md:rounded-bl-[60px] md:rounded-tr-[60px] bg-gradient-to-b from-[#140F0ACC] to-[#BE9C7CCC] backdrop-blur-sm border-b-2 border-l-2 border-white relative top-[40px] md:top-[80px] xl:left-[120px] ml-[40px] mr-[12px] xl:mx-auto">
        <h3 class="mb-[40px] md:mb-[80px] text-[2rem] md:text-[3rem] text-[#FFFFFF] w-[304px] flex items-center relative after:w-full after:max-w-[165px] after:h-[2px] after:bg-[#FFFFFF] after:ml-[40px] font-bold"><span>關於<br>我們</span></h3>
        <p class="mb-[40px] text-[#FFFFFF] mb-[40px] text-[#FFFFFF] text-[0.875rem] md:text-[1rem]">享樂酒店，位於美麗島高雄的心臟地帶，是這座城市的璀璨瑰寶與傲人地標。<br>我們的存在，不僅僅是為了提供奢華的住宿體驗，更是為了將高雄的美麗與活力，獻給每一位蒞臨的旅客。</p>
        <p class="mb-[40px] text-[#FFFFFF] mb-[40px] text-[#FFFFFF] text-[0.875rem] md:text-[1rem]">我們的酒店，擁有時尚典雅的裝潢，每一個細節都充滿著藝術與設計的精緻。<br>我們的員工，都以熱情的服務與專業的態度，讓每一位客人都能感受到賓至如歸的溫暖。</p>
        <p class="mb-[40px] text-[#FFFFFF] mb-[40px] text-[#FFFFFF] text-[0.875rem] md:text-[1rem]">在這裡，您可以遙望窗外，欣賞高雄的城市景色，感受這座城市的繁華與活力；您也可以舒適地坐在我們的餐廳，品嚐精緻的佳餚，體驗無與倫比的味覺盛宴。</p>
        <p class="text-[#FFFFFF] text-[#FFFFFF] text-[0.875rem] md:text-[1rem]">享樂酒店，不僅是您在高雄的住宿之選，更是您感受高雄魅力的最佳舞台。我們期待著您的蒞臨，讓我們共同編織一段難忘的高雄故事。</p>
      </div>
    </section>
    <section :class="`pt-[28%] md:py-[120px] bg-[#140F0A] relative bg-no-repeat bg-none md:bg-[url(${bg})] bg-contain bg-[center_450px]`">
      ...
      <div class="max-w-[1608px] flex flex-col md:flex-row items-end">        
        ...
        <div :class="`w-full xl:max-w-[1060px] mb-[80px] md:mb-0 h-full bg-no-repeat bg-[url(${mobile_bg2})] md:bg-none bg-contain bg-[right_top]`">
          <div class="px-[12px] w-full xl:max-w-[628px]">
            <h4 class="text-[#FFFFFF] text-[1.75rem] md:text-[2.5rem] mb-[16px] font-bold">尊爵雙人房</h4>
            <p class="text-[#FFFFFF] mb-[24px] md:mb-[40px] text-[0.875rem] md:text-[1rem]">享受高級的住宿體驗，尊爵雙人房提供給您舒適寬敞的空間和精緻的裝潢。</p>
            <h5 class="text-[#FFFFFF] text-[1.5rem] md:text-[2rem] mb-[30px] md:mb-[40px] font-bold font-bold">NT$ 10,000</h5>
            <router-link :to="{name:'Book'}" class="relative z-10 p-[20px] md:p-[40px] text-[1rem] font-bold md:text-[1.5rem] bg-[#FFFFFF] block w-full rounded-lg hover:bg-[#BF9D7D] hover:text-[#FFFFFF] group mb-[24px] md:mb-[40px]"><span class="flex justify-end items-center">查看更多<span class="ml-[15px] h-[2px] bg-[#140F0A] block w-full max-w-[80px] md:max-w-[150px] group-hover:bg-[#FFFFFF]"></span></span></router-link>
            <div class="flex justify-end">
              <button @click="goPrev()" class="w-[50px] h-[50px] inline-flex items-center justify-center">
                <svg class="w-[24px] h-[24px]" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path class="fill-[#BF9D7D]" d="M12 20L13.41 18.59L7.83 13L20 13L20 11L7.83 11L13.41 5.41L12 4L4 12L12 20Z" fill="black"/>
                </svg>
              </button>
    ...
    <section class="px-[12px] overflow-hidden bg-[#F7F2EE] flex py-[80px] md:py-[120px] relative after:absolute after:z-20 after:right-[80px] after:top-[-40px] after:w-[200px] after:h-[200px] after:bg-contain">
    ...
    <section class=" bg-[#140F0A] pt-[80px] md:pt-[120px] pb-[80px]">
      <div class="px-[12px] max-w-[1296px] mx-auto">
        <h3 class="text-[#BF9D7D] text-[2rem] font-bold md:text-[3rem] mb-[40px] md:mb-[80px] flex items-center after:block after:ml-[24px] after:h-[2px] after:w-[167px] after:bg-gradient-to-r after:from-[#BE9C7C] after:to-[#FFFFFF]">交通<br>方式</h3>
        ...
        <div class="flex flex-col md:flex-row mb-[80px]">
          <div class="mr-[24px] mb-[24px] md:mb-0">          
            ...
            <p class="tracking-[2px] text-[#FFFFFF] text-[0.875rem] md:text-[1rem] ">如果您選擇自行開車，可以透過國道一號下高雄交流道，往市區方向行駛，並依路標指示即可抵達「享樂酒店」。飯店內設有停車場，讓您停車方便。</p>
          </div>
          <div class="mr-[24px] mb-[24px] md:mb-0">
            ...
            <p class="tracking-[2px] text-[#FFFFFF] text-[0.875rem] md:text-[1rem] ">如果您是搭乘高鐵或火車，可於左營站下車，外頭有計程車站，搭乘計程車約20分鐘即可抵達。或者您也可以轉乘捷運紅線至中央公園站下車，步行約10分鐘便可抵達。</p>
          </div>
          <div>
